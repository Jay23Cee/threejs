 ...
 */
 ...
 fontLoader.load(
     ...
     (font) =>
     {
        ...
        //  textGeometry.position.z=-4
        //  textGeometry.position.y=5
 
         const text = new THREE.Mesh(textGeometry, material)
         text.rotation.y = Math.PI * 0.01
            text.position.y = 2.05 + 1.5
            text.position.x = -2.5 + 1.5
            text.position.z = .5 + 1.5
         scene.add(text)
...
// Name light
const nameLight = new THREE.PointLight('#ffffff', 1, 7)
nameLight.castShadow = true
nameLight.shadow.mapSize.width = 256
nameLight.shadow.mapSize.height = 256
nameLight.shadow.camera.far = 7

nameLight.position.set(1, 6.2, 3.7)
house.add(nameLight)
